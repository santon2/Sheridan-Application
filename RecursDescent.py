...
# Grammar
# prog -> VAR tail1 | NUM tail2 | MINUS {VAR NUM} tail2 | LP expr RP
# tail1 -> EQ expr SEMI prog | {PLUS MINUS} term tail2 |
#          {MULT DIVI} factor tail3 | epsilon
# expr -> term tail2
# tail2 -> {PLUS MINUS} term tail2 | epsilon
# term -> factor tail3
# tail3 -> {MULTDIVI} factor tail3 | epsilon
# factor -> LP expr RP | MINUS {NUM VAR} | NUM | VAR
...
# tail3 -> {MULT DIVI} factor tail3 | epsilon
# function tail3 --------------------------------------------- 
